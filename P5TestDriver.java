 ...
 *
 * @author Kurt Mammen
 * @version 03/03/2016 - Dave Parkinson, changed O(1) tests to calibrate to machine
 * @version 12/04/2015 - Changed O(1) tests to be less system dependent
 * @version 11/16/2015 - Tuned O(1) tests.
...
{
   private static final String RESULTS_FOR = "Results for Project 5";
   
   private static final boolean testIterator = false;
   ...
   {
      System.out.println("Testing a BasicLinkedList of one element...");  
      ...
      pass &= test(caught, "get(-99)");
      System.out.println("Start Failing"); 
   ...
   {
      System.out.println("Testing a BasicLinkedList of two elements...");
   ...
   {
      System.out.println("Testing a BasicLinkedList of three elements...");
   ...
   private static boolean testAddForOrderOnePerformance()
   {
      ...
      //System.out.println("Add 10 to short list: " + time1);
      ...
      //System.out.println("Add 10 to long list: " + time2);
      
      //System.out.println("time 1: " + time1 + ", time 2: " + time2);
      pass &= test((time2-time1) < 2*time1, 
         "\n\"Add to end\" performance does not appear to be O(1) as required\n");
   ...
   private static boolean testSizeForOrderOnePerformance()
   {
      ...
      System.out.println("Size() processing time, short list 1: " + time1 + ", long list: " + time2);
      pass &= test(time2 < 3*time1, 
         "\nSize() method performance does not appear to be O(1) as required\n");
   ...
   private static boolean testBasicListIteratorForOrderOnePerformance()
   {
      ...
      double time1 = System.nanoTime() - start;
      ...
      double time2 = System.nanoTime() - start;

      //System.out.println("Iterator next, time1: " + time1 + " , time2: " + time2);
      
      pass &= test(time2 < time1*40, 
      ...
      //System.out.println("Iterator previous, time1: " + time1 + " , time2: " + time2);
   ...
   private static void printResults(boolean pass)
   {
      ...
      if(pass)
      {
         msg = "\nCongratulations, you MAY HAVE passed all the tests!\n\n"
            + "The tests checking for O(1) performance are designed to calibrate\n"
            + "the processing timing tests to the machine being used.\n"
            + "However, it is advisable that you run your code on one of CS servers\n"
      ...
      else
      {
         msg = "\nNot done yet - you failed one or more tests!\n\n"
            ...
            + "you are required to test on.\n"
            + "If you are running on one of those systems and your code is failing,\n"
